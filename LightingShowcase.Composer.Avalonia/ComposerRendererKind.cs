 ...
 *
 * `ComposerRendererKind` makes a closed set of choices compiler-visible instead of passing loosely related
 * integers or strings. Code that switches over `Raster`, `VulkanRaster`, `VulkanCompute`, `Cpu` is where the
