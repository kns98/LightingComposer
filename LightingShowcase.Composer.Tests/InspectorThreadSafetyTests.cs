...
public sealed class InspectorThreadSafetyTests
{
    ...
    // contains only plain data and no avalonia objects. The assertions establish that forbidden/unwanted entries
    // must not be exposed. Representative cases include Avalonia.
    [Fact]
    ...
    // must produce an observable change. Representative cases include 3, -2, 1, 0, 30, 1.25, Worker transformed.
    [Fact]
