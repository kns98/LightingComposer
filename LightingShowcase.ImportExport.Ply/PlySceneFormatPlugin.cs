/*
 * This adapter registers PLY with the format registry. The registry sees a uniform `SceneFormat` capability,
 * while this assembly remains responsible for constructing the actual PLY loader/saver; that keeps the core scene
